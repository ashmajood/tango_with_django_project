...
# The .get() method returns one model instance or raises an exception. category = 
        Category.objects.get(slug=category_name_slug)
# Retrieve all of the associated pages.
# The filter() will return a list of page objects or an empty list. pages =     
        Page.objects.filter(category=category)
...
# A HTTP POST?
    if request.method == 'POST':
        ...
        if form.is_valid():
# Save the new category to the database. form.save(commit=True)
